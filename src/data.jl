...
@compat Dict("hilb" => "Hilbert matrix:
             \n Input options:
             \n 1. dim: the dimension of the matrix;
             \n 2. row_dim, col_dim: the row and column dimension.
             ...
             \n Input options:
             \n 1. dim: the dimension of the matrix, n is a power of 2.
             ...
             \n Input options:
             \n 1. vec1, vec2: two vectors;
             \n 2. vec: a vector;
             \n 3. dim: the dimension of the matrix.
             \n ['inverse', 'ill-cond', 'symmetric', 'pos-def']
             ...
             \n Input options:
             \n 1. vec, n: a vector and the column dimension;
             \n 2. vec: a vector;
             \n 3. dim: the dimension of the matrix.
             ...
             "frank" => "Frank matrix:
             \n Input options:
             \n 1. n, k: n is the dimension of the matrix, k = 0 or 1.
             If k = 1 the matrix reflect about the anti-diagonal;
             \n 2. n: n is the dimension of the matrix.
             \n ['ill-cond', 'eigen']
             ...
             \n Input options:
             \n 1. n, alpha, lambda: n is the dimension of the matrix.
             alpha and lambda are scalars;
             \n 2. n: alpha = sqrt(eps(type)) and lambda = 0.
             ...
             "grcar" => "Grcar Matrix:
             \n Input options:
             \n 1. dim, k: dim is the dimension of the matrix and
             ...
             "triw" => "Triw Matrix:
             \n Input options:
             \n 1. row_dim, col_dim, alpha, k: row_dim and col_dim
             ...
             "moler" => "Moler Matrix:
             \n Input options:
             \n 1. dim, alpha: dim is the dimension of the matrix,
             alpha is a scalar;
             \n 2. dim: alpha = -1.
             \n ['inverse', 'ill-cond', 'symmetric', 'pos-def']
             ...
             "kahan" => "Kahan Matrix:
             \n Input options:
             \n 1. m, n, theta, pert: m, n are the row and column
             dimensions of the matrix. theta and pert are scalars;
             \n 2. dim, theta, pert: dim is the dimension of the matrix;
             \n 3. dim: theta = 1.2, pert = 25.
             \n ['inverse', 'ill-cond']
             ...
             \n Input options:
             \n 1. vec, dim: vec is a vector, dim is the number of columns.
             \n 2. vec
             \n 3. dim
             \n ['inverse', 'ill-cond']
             ...
             \n Input options:
             \n 1. dim: dim is the dimension of the matrix.
             \n ['inverse', 'ill-cond', 'eigen']
             ...
             \n Input options:
             \n 1. dim, k: dim is the dimension of the matrix.
             ...
             \n Input options:
             \n 1. vec: vec is a vector;
             \n 2. dim: dim is the dimension of the matrix.
             \n ['inverse', 'symmetric', 'eigen']
             ...
             \n Input options:
             \n 1. v1, v2, v3: v1 and v3 are sub- superdiagonal vectors.
             v2 is the diagonal vector;
             \n 2. dim, x, y, z: dim is the dimension of the matrix. x, y, z are
             ...
             "chow" => "Chow Matrix:
             \n Input options:
             \n 1. dim, alpha, delta: dim is dimension of the matrix.
             ...
             \n Input options:
             \n 1. n: the dimension of the matirx is n^2.
             ...
             \n 1. n: the dimension of the matrix is n^2.
             \n ['eigen', 'sparse']
             ...
             \n Input options:
             \n 1. dim, a, b: dim is the dimension of the matrix.
             ...
             \n Input options:
             \n 1. vec: vec is a vector with no repeated elements;
             \n 2. dim: the dimension of the matrix.
             \n ['eigen']
             ...
             \n Input options:
             \n 1. m, n, k: m and n are row and column dimensions,
             ...
             \n Input options:
             \n 1. m, n, kappa, mode: m, n are the dimensions of the matrix.
             ...
             \n Input options:
             \n 1. n : n is the dimension of the matrix.
             \n ['random']
             ...
             \n Input:
             \n 1. n, rho: n is the dimension of the matrix, rho is a
             ...
             \n Input options:
             \n 1. nx, ny: the dimension of the matrix is equal to
             3 * nx * ny + 2 * nx * ny + 1;
             \n 2. n: nx = ny = n.
             ...
             \n Input options:
             \n 1. Σ: the singular vaule spectrum of the matrix;
             \n 2. n, mode: n is the dimension of the matrix. 
             ...
             \n Input options:
             \n 1. vc, vr: vc and vr are the first column and row of the matrix;
             \n 2. v: symmatric case, i.e., vc = vr = v;
             \n 3.  n: the dimension of the matrix is n, v = [1:n;] is the first
             ...
             \n Input options:
             \n 1. n: the dimension of the matrix is n.
             ...
             \n Input options:
             \n 1. n: the dimesion of the matrix n must be even.
             ...
             \n Input options:
             \n 1. n, t1, t2: the dimension of matrix is n. t1 and t2 are 
             two real scalars such that 0 < t1 < t2 < 1;
             \n 2. n: t1 = 1/3 and t2 = 2/3.
             ...
             \n Input options:
             \n 1. n, κ: the dimension of the matrix is n and n 
             ...
             \n Input options:
             \n 1. n: the dimenstion of the matrix is n.
